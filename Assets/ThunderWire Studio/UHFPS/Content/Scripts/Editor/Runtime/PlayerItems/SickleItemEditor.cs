...
{
    [CustomEditor(typeof(SickleItem))]
    public class SickleItemEditor : PlayerItemEditor<SickleItem>
    {
        public override void OnInspectorGUI()
        {
            EditorDrawing.DrawInspectorHeader(new GUIContent("Sickle Item"), Target);
