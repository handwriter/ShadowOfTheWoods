...
{
    public class DomovoyPatrolState : AIStateAsset
    {
        ...
        public override string ToString() => "Domovoy Patrol";

        public class PatrolState : FSMAIState
        {
            private readonly ZombieStateGroup Group;
            private readonly DomovoyPatrolState State;
            ...
            public PatrolState(NPCStateMachine machine, AIStatesGroup group, AIStateAsset state) : base(machine) 
            {
                ...
                State = (DomovoyPatrolState)state;
            }

            public override Transition[] OnGetTransitions()
            {
                return new Transition[] { Transition.To<DomovoyChaseState>(() => !playerMachine.IsCurrent(PlayerStateMachine.HIDING_STATE)
