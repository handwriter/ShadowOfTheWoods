...
{
    public class WaterMonsterPatrolState : AIStateAsset
    {
        ...
        public float TimeToWaitPlayerInSwamp;
        ...
        public override string ToString() => "Water Monster Patrol";

        public class PatrolState : FSMAIState
        {
            private readonly ZombieStateGroup Group;
            private readonly WaterMonsterPatrolState State;
            ...
            public PatrolState(NPCStateMachine machine, AIStatesGroup group, AIStateAsset state) : base(machine)
            {
                ...
                State = (WaterMonsterPatrolState)state;
            }

            public override Transition[] OnGetTransitions()
            {
                return new Transition[] { Transition.To<WaterMonsterChaseState>(() => !IsPlayerDead && PlayerManager.Instance.IsInSwamp && PlayerManager.Instance.TimeInSwamp >= State.TimeToWaitPlayerInSwamp)
                        };
            }
