...
{
    public class WaterMonsterPlayerHideState : AIStateAsset
    {
        ...
        public class PlayerHideState : FSMAIState
        {
            ...
            private readonly WaterMonsterPlayerHideState State;
            ...
            public PlayerHideState(NPCStateMachine machine, AIStatesGroup group, AIStateAsset state) : base(machine)
            {
                ...
                State = (WaterMonsterPlayerHideState)state;
            ...
            public override Transition[] OnGetTransitions()
            {
                ...
                {
                    Transition.To<WaterMonsterPatrolState>(() => patrolTime > State.PatrolTime),
                    Transition.To<WaterMonsterChaseState>(() => chasePlayer && !IsPlayerHiding)
                };
            }
